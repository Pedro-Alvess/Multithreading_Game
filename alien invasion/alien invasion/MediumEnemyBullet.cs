...
{
    internal class MediumEnemyBullet: Bullet
    {
        private PictureBox _bullet;
        private int _speed = 7;

        public MediumEnemyBullet(int startX, int startY)
        {
            _bullet = base.creatBullet(18,32, "enemyMediummBullet.png", startX, startY);
        }
